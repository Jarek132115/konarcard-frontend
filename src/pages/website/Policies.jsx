        ...
        return (
          <div className="kc-pol__contentCard">
            ...
            <div className="kc-pol__block">
              ...
              <ul className="kc-pol__ul">
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> Provide and operate KonarCard</li>
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> Create and manage your account</li>
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> Display your digital business card as intended</li>
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> Process payments and subscriptions</li>
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> Communicate with you about your account or support requests</li>
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> Improve our website, features, and user experience</li>
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> Comply with legal obligations</li>
              </ul>
            </div>
        ...
        return (
          <div className="kc-pol__contentCard">
            ...
            <div className="kc-pol__block">
              ...
              <ul className="kc-pol__ul">
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> You must provide accurate information</li>
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> You are responsible for what you publish on your profile</li>
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> You must not misuse the platform or attempt unauthorised access</li>
              </ul>
            </div>
            ...
            <div className="kc-pol__block">
              ...
              <p className="body-s kc-pol__p">You agree not to:</p>
              <ul className="kc-pol__ul">
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> Upload illegal, abusive, or infringing content</li>
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> Use KonarCard to spam or harass others</li>
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> Interfere with or disrupt the Service</li>
              </ul>
            </div>
        ...
        return (
          <div className="kc-pol__contentCard">
            ...
            <div className="kc-pol__block">
              ...
              <ul className="kc-pol__ul">
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> NFC chip failure under normal use</li>
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> Manufacturing defects affecting usability</li>
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> Faults present at delivery</li>
              </ul>
            </div>
            ...
            <div className="kc-pol__block">
              ...
              <ul className="kc-pol__ul">
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> Normal wear and tear</li>
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> Damage caused by misuse, bending, exposure to extreme heat/water</li>
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> Cosmetic scratches that don’t affect function</li>
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> Lost or stolen cards</li>
              </ul>
            </div>
        ...
        return (
          <div className="kc-pol__contentCard">
            ...
            <div className="kc-pol__block">
              ...
              <ul className="kc-pol__ul">
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> Essential cookies for login and security</li>
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> Performance cookies to improve speed and reliability</li>
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> Analytics cookies to understand traffic and usage</li>
              </ul>
            </div>
        ...
        return (
          <div className="kc-pol__contentCard">
            ...
            <div className="kc-pol__block">
              ...
              <ul className="kc-pol__ul">
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> You’ll receive tracking when available</li>
                <li><img src={DotIcon} alt="" className="kc-pol__dot" /> Ensure your delivery address is accurate</li>
              </ul>
            </div>
                  ...
                  <ul className="kc-pol__sideList">
                    {policies.map((p) => (
                      <li key={p.key}>
                        ...
                        >
                          <span>{p.label}</span>
                          <span className="kc-pol__sideArrow" aria-hidden="true">→</span>
                        </button>
                      </li>
                    ))}
                  </ul>
