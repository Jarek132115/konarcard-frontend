...
export default function Home() {
  ...
  return (
    <>
      ...
      <div style={{ paddingBottom: 40 }} className="section">
        <div className="section-1-title">
