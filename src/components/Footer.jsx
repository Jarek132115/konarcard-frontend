                ...
                <div className="footer-info">
                    ...
                    <div className="footer-info-right">
                        <div className="footer-column">
                            ...
                            <Link to="/productandplan/konarcard" ><p style={{ color: '#333', marginBottom: 5 }} className='desktop-body-s footer-page-link'>Konar Card</p></Link>
                            <Link to="/productandplan/konarsubscription" ><p style={{ color: '#333', marginBottom: 5 }} className='desktop-body-s footer-page-link'>Konar Subscription</p></Link>
